"""support_agent — MV4-02 customer service reply drafts with RAG + order context."""
...
async def support_node(state: TaskState) -> dict[str, object]:
    """support_agent — generate customer service reply drafts using RAG + order data."""
    ...
    try:
        ...
        prompt = _build_user_prompt(state, order_context, rag_references)
            ...
            [
                Message(
                    ...
                    content=(
                        ...
                        "Use the order context and knowledge base references provided. "
                        "For refund/compensation requests, set requires_human_review=true. "
