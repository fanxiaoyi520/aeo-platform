...
_DTC_OPS_GRAPH = SubGraphDefinition(
    graph_id="dtc_ops",
    display_name="DTC Operations Agent",
    description="Shopify store health monitoring and operational recommendations.",
    category=AgentCategory.OPERATIONS,
    agent_ids=["dtc_operations_agent"],
)
...
_GRAPH_CATALOG: dict[str, SubGraphDefinition] = {
    ...
    _DTC_OPS_GRAPH.graph_id: _DTC_OPS_GRAPH,
}
