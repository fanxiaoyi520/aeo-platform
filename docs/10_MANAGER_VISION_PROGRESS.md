...
| 模块 | 名称 | 状态 | 完成度 | 阶段 |
|------|------|------|--------|------|
| MV-M01 | 多 Agent 平台与调度 | `in_progress` | 40% | MV1 |
...
| MV1-03 | 多图编排：父任务 → 子 Agent 图 | MV-M01 | `pending` | MV1-02 |
...
| 2026-09-01 | **MV1-02** 跨 Agent 调度器 merged PR #28（优先级队列 + 并发配额） |
