"""S7-01 — Yuanzheng pilot SKU test set acceptance."""
...
TESTSET_JSON = _LAUNCH_AEO_ROOT / "pilot" / "yuanzheng-sku-testset.json"
TESTSET_DOC = _REPO_ROOT / "docs" / "pilot" / "yuanzheng-sku-testset.md"
...
def test_s7_01_doc_references_json_path() -> None:
    ...
    assert "yuanzheng-sku-testset.json" in text
