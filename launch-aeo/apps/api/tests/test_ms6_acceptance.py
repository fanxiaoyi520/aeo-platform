...
def test_ms6_prod_compose_supports_offline_hash_embeddings() -> None:
    ...
    compose_path = _LAUNCH_AEO_ROOT / "infra/compose/docker-compose.prod.yml"
    env_path = _LAUNCH_AEO_ROOT / ".env.prod.example"
...
def test_ms6_env_prod_example_documents_security_controls() -> None:
    text = (_LAUNCH_AEO_ROOT / ".env.prod.example").read_text(encoding="utf-8")
